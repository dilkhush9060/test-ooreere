...
interface DataTableProps<TData, TValue> {
  ...
  data: TData[];
  searchColumn?: string; // Optional prop to specify which column to search
}
...
export function DataTable<TData, TValue>({
  ...
  const getFilterColumn = () => {
    ...
    const commonColumns = ["name", "title", "account", "email", "username"];
