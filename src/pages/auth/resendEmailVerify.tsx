...
export default function ResendEmailVerification() {
  ...
  const {mutate, isPending} = useMutation({
    ...
    mutationFn: async (data: FormData) => {
      return Api.post("/auth/account/email", data).then((res) => res.data);
    },
  ...
  return (
    <div className="justify-between bg-gradient-to-r from-[#FFF7EB] to-white">
      <div className="mx-auto flex min-h-screen max-w-screen-xl flex-col items-center justify-center px-6 py-14">
        <div className="flex flex-shrink-0 flex-col items-center justify-center">
          ...
          <p className="my-4 text-center text-xs leading-4 text-[#979DA3]">
            Enter your email so that we can send you new OTP
          </p>
